...
<div class="g">
    <div class="fr u-4-5"><!--栏目 -->
        <div class="part-area clearfix">
            <div class="fl">
                <h1 style="font-size: 18px;">库存列表</h1>
            </div>
        </div>
        <div class="hr-3"></div>
        <!--搜索条件-->
        <div style="font-size: 16px;padding: 10px 0;">
            <form action="/vmallshop/index.php/Home/Stock/index" method="get">
                选择仓库：
        ...
        <div class="myOrders-area">
            <div class="myOrders-title-area">
                <div class="b">
                    <table border="1" cellpadding="0" cellspacing="0" id="order-list-head" style="font-size: 14px;">
                        <thead>
                        <tr>
                            <th>库存ID</th>
                            <th>仓库名称</th>
                        ...
                        <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="width: 100%;text-align: center">
                                <td><?php echo ($vo["stock_id"]); ?></td>
                                <td><?php echo ($vo["customer_name"]); ?></td>
                                <td style="width: 200px;"> <?php echo ($vo["goods_name"]); ?></td>
