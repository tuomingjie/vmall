...
<div class="layout">
    ...
    <div class="order-confirm" id="order-confirm-detail">
		<div class="h">
			...
			<h3>订单提交成功，请您尽快付款！</h3>			
			<p>订单号：&nbsp;&nbsp;<?php echo ($order_info["order_no"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;付款金额（元）：&nbsp;&nbsp;<b><?php echo ($order_info["order_end_money"]); ?></b>&nbsp;<b>元</b></p>
				...
				<div class="b clearfix" id="payment-bank-list-shortcut">
					<ul>
						<li>
							...
							<span><img src="/vmallshop/Public/images/alipay.jpg" width="120" height="40"></span>
							</div>
						</li>
