...
<div class="g">
    <div class="fr u-4-5"><!--栏目 -->
        <div class="part-area clearfix">
            <div class="fl">
                <h1 style="font-size: 18px;">调拨记录</h1>
            </div>
        </div>
        <div class="hr-3"></div>
        <!--搜索条件-->
        <div style="font-size: 16px;padding: 10px 0;">
            <form action="/vmallshop/index.php/Home/Stock/redeploy_log" method="get">
                选择仓库：
                ...
                <div class="b">
                    <table border="1" cellpadding="0" cellspacing="0" id="order-list-head" style="text-align: center;font-size: 14px;">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["redeploy_id"]); ?>">
                                ...
                                <td><?php echo ($vo["out_customer_name"]); ?></td>
                                <td> <?php echo ($vo["goods_name"]); ?></td>
                                <td> <?php echo ($vo["goods_num"]); ?></td>
                                <td><?php echo ($vo["into_customer_name"]); ?></td>
