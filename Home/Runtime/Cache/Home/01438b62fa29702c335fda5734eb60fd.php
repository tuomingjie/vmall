...
<div class="balance-area">
	<div class="balance-have">您的余额:<?php echo ((isset($account_money) && ($account_money !== ""))?($account_money):0.00); ?>元</div>
    <!--账户余额-消费明细列表 -->
    <dl>
    	<dt>消费明细列表（0条）</dt>
        <dd>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <thead>
						   ...
						   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
                                <td  style="height:34px"><?php echo (date("Y-m-d H:i:s",$vo["user_payment_time"])); ?></td>
                                <td  style="height:34px;"><?php echo ($vo["user_payment_money"]); ?></td>
                                <td style="height:34px;"><?php echo ($vo["user_payment_why"]); ?></td>
						   </tr><?php endforeach; endif; else: echo "" ;endif; ?>
						   <?php if($data_status == 1): ?><tr align="right">
            ...
            <!--通知通告-空数据 --> 
            <div class="inform-empty-area  <?php echo ($none_hide); ?>">对不起，您暂时没有信息！</div>
            <div class="hr-20"></div>
            <!--分页 -->
...
<script src="/vmallshop/Public/Js/balance.js"></script></div>
...
<div id="AutocompleteContainter_919b5" style="position: absolute; z-index: 9999; top: 93px; left: 556.5px;"><div class="autocomplete-w1"><div class="autocomplete" id="Autocomplete_919b5" style="display: none; width: 315px; max-height: 400px;"></div></div></div></body></html>