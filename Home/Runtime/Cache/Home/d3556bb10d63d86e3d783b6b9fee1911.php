...
<div class="g">
    <div class="fr u-4-5"><!--栏目 -->
        ...
        <div style="font-size: 16px;padding: 10px 0;">
            <form action="/vmallshop/index.php/Home/Stock/log" method="get">
                选择仓库：
                ...
                <div class="b">
                    <table border="1" cellpadding="0" cellspacing="0" id="order-list-head" style="text-align: center;font-size: 14px;">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["stock_desc_id"]); ?>">
                                ...
                                <td style="width: 200px"><?php echo ($vo["stock_no"]); ?></td>
                                ...
                                <td>
                                    <a href="/vmallshop/index.php/Home/Stock/edit?stock_desc_id=<?php echo ($vo["stock_desc_id"]); ?>">编辑</a>
                                    &nbsp;<a href="#" onclick="del(<?php echo ($vo["stock_desc_id"]); ?>)">删除</a>
                                </td>
...
<script>
    function del(id) {
        $.ajax({
            url:"/vmallshop/index.php/Home/Stock/delete",
            type:'post',
            dataType:'json',
            data:{
                del_id:id
