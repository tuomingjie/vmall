...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					用户名：<input type="text" name="user_name" value="<?php echo ($_POST['user_name']); ?>" /> <!-- [姓名]
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/vmallshop/index.php/Admin/User/add" target="dialog" width="550" height="380" rel="user_msg" title="添加会员"><span>添加</span></a></li>
			<li><a class="delete" href="/vmallshop/index.php/Admin/User/del/user_id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/listuser" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="112">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["user_id"]); ?>">
					...
					<td><?php if($vo['user_sex'] == 0): ?>保密<?php endif; if($vo['user_sex'] == 1): ?>男士<?php endif; if($vo['user_sex'] == 2): ?>女士<?php endif; ?></td>
