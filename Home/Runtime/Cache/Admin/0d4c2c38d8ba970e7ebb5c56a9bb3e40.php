...
<div class="pageContent">
	<form method="post" action="/vmallshop/index.php/Admin/IndexSale/update/navTabId/listIndexSale/callbackType/closeCurrent"  class="pageForm required-validate" 
		onsubmit="return  iframeCallback(this, navTabAjaxDone);" enctype="multipart/form-data"><?php  ?>
		<input type="hidden" name="index_sale_id" value="<?php echo ($vo["index_sale_id"]); ?>"/>
		...
		<div class="pageFormContent" layoutH="60">
			...
			<dl>
				<dt>促销的图片:</dt>
				<dd><input type="file"  style="width:100%" name="index_sale_img" /></dd>
			</dl>
			...
			<dl>
				...
				<select class="combox required" name="goods_id" id="w_combox_city" ref="w_combox_area" >
					...
					<?php if(is_array($cat_info)): $i = 0; $__LIST__ = $cat_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><option value=<?php echo ($vo1["goods_id"]); ?> <?php echo $vo1['goods_id']==$vo['goods_id']?'selected':'';?> ><?php echo ($vo1["goods_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>			
			</dl>
