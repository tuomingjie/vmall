...
<div class="list" style="margin-top: 44px">
    ...
    <label class="item item-input" id="ttt">
        <span style="margin-left: 120px;">
            <img class="vam pointer" id="verifyimg" src="/vmallshop/index.php/Mobile/Login/verify" alt="验证码" onclick="fleshVerify()" width="160">
        </span>
    </label>
</div>
<div class="content padding" style="text-align: right">
    <button class="button button-block button-calm" id="action">登录</button>
    <!--<a href="/vmallshop/index.php/Mobile/LoginSupplier/index">供应商登录</a>-->
</div>
</body>
<script>
    $('#ttt').click(function() {
...
<script type="text/javascript">
    $('#action').click(function() {
        ...
        $.ajax({
            url: "/vmallshop/index.php/Mobile/Login/loginaction",
            type: 'post',
            dataType: 'json',
            data: {
                uname:account,
