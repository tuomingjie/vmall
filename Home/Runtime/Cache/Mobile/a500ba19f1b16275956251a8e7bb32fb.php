...
<body>
    ...
    <div class="list">
        <label class="item item-input">
            ...
            <input type="text" id="addr_name" name="addr_name" placeholder="收货人" value="" >
        </label>
        <label class="item item-input">
            <span class="input-label">手机号：</span>
            <input type="text" id="addr_phone" name="addr_phone" placeholder="收货联系电话" value="" >
        </label>
        <label class="item item-input">
        ...
        <label class="item item-input">
            ...
            <input type="text" id="addr_detail" name="addr_detail" placeholder="不用重复省、市、区/县" value="" >
        </label>
        <label class="item item-input">
            <span class="input-label">邮政编码：</span>
            <input type="text" id="addr_post" name="addr_post" placeholder="邮政编码" value="" >
        </label>
    </div>
