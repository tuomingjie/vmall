...
.grid .gridTbody td div{height:90px;text-align:center;line-height:90px;}
.grid .gridCol{text-align:center;}
</style>
<form id="pagerForm" action="/vmallshop/index.php/Supplier/Goods/index" method="post">
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					商品名称：<input type="text" name="goods_name" value="<?php echo ($_POST['goods_name']); ?>" /> 
	...
	<table class="table" width="100%" layoutH="112">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["goods_id"]); ?>">
					...
					<td><img src="/vmallshop/Upload<?php echo ($vo["goods_big_pic"]); ?>"  style="width:90px;height:90px;"/></td>
