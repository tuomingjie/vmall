...
<head runat="server">
    ...
    <title>供应商管理登录界面</title>
    <link href="/vmallshop/Public/Admin/Login/index/Css/alogin.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server" action="/vmallshop/index.php/Supplier/Login/checkLogin" method="post">
    <div class="Main">
        <ul>
            <li class="top"></li>
            <li class="top2"></li>
                ...
                <ul class="login">
                    ...
                    <li><span class="left login-text">密码：</span> <span style="left">
                       <input id="Text2" type="password" class="txt" name="password" />  
                        ...
                        <input id="Text1" type="text" class="txt1" name="verify"/><img class='vercode' src="/vmallshop/index.php/Supplier/Login/verify" onclick="this.src=this.src+='?'+Math.random()">  
